    ...
    while(menu != 11){
        ...
        switch (menu) {
            case 1:
                ...
                t = clock() - t;
                t = ((float)t)*1000;
                printf("- Insercion de un vértice: %f milisegundos.\n",((float)t)/CLOCKS_PER_SEC);
                break;
            case 2:
                cout << "De vertice: ";
                cin >> ver1;
                ...
                t = clock() - t;
                t = ((float)t)*1000;
                printf("- Insercion de una arista: %f milisegundos.\n",((float)t)/CLOCKS_PER_SEC);
                break;
            case 3:
                cout << "Numero de vertice: ";
                cin >> num;
                ...
                t = clock() - t;
                t = ((float)t)*1000;
                printf("- Eliminación de un vertice: %f milisegundos.\n",((float)t)/CLOCKS_PER_SEC);
                break;
            case 4:
                cout << "De vertice: ";
                cin >> ver1;
                ...
                t = clock() - t;
                t = ((float)t)*1000;
                printf("- Eliminación de una arista: %f milisegundos.\n",((float)t)/CLOCKS_PER_SEC);
                break;
            case 5:
                if(!empty(grafo))
                    t = clock();
            ...
            case 9:
                if(!empty(grafo))
                    ...
                    t = clock() - t;
                    t = ((float)t)*1000;
                    printf("- DIJKSTRA: %f milisegundos.\n",((float)t)/CLOCKS_PER_SEC);
                break;
            case 10:
                if(!empty(grafo))
                    t = clock();
                    ...
                    t = clock() - t;
                    t = ((float)t)*1000;
                    printf("- FLOYD-WARSHAL: %f milisegundos.\n",((float)t)/CLOCKS_PER_SEC);
                break;
            case 11:
                break;
            default:
